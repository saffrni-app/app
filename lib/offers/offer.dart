      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text("FACILITIES",style: Theme.of(context).textTheme.subtitle1,),
          ),
          SizedBox(height: 9,),
          SingleChildScrollView(
            scrollDirection: Axis.horizontal,
              ...
              children: [
                ...
                Column(
                  children: [
                    CircleAvatar(
                      backgroundColor: Colors.white,
                      backgroundImage:AssetImage('images/pool.jpg'),
                      radius:25,
                ...
                Column(
                  children: [
                    CircleAvatar(
                      backgroundColor: Colors.white,
                      backgroundImage:AssetImage('images/break.jpg'),
                      radius:25,

                    ),
                    Text('Free breakfast',style: TextStyle(
                      letterSpacing: 0.5,
                      fontSize: 13.0,
                      fontWeight: FontWeight.w500,
                      color: LightColors.green,
          ...
          Padding(
              padding: const EdgeInsets.only(right: 230),
              child: Text('LOCATION',style: Theme.of(context).textTheme.subtitle1,
              )
          ),
          SizedBox(height: 20,),
